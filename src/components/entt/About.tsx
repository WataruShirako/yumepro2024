  ...
  return (
    <section id="about" className={""}>
      ...
      <div className="container m-auto max-w-[92%] lg:max-w-2xl">
        <div className="list flex py-5 md:py-8 border-solid border-t border-[#485757] items-center justify-between gap-2">
          <p
            className={
        ...
        <div className="list flex py-5 md:py-8 border-solid border-y border-[#485757] items-center justify-between gap-2">
          <p
            className={
              "w-1/4 md:w-1/5 text-xs md:text-sm leading-5 md:leading-8"
            }
