  ...
  return (
    <section id="sponsor" className={''}>
      ...
      <div className="container m-auto max-w-[92%] lg:max-w-2xl">
        <div className="list flex py-5 md:py-8 border-solid border-t border-[#485757] items-center">
          ...
          <div className={'w-3/4 md:w-4/5 text-xs md:text-sm leading-5 md:leading-8'}>
        ...
        <div className="list flex py-5 md:py-8 border-solid border-y border-[#485757] items-center">
          <p className={'w-1/4 md:w-1/5 text-xs md:text-sm leading-5 md:leading-8'}>
