      ...
      <div className="btnArea">
        ...
        >
          <a
            ...
            className="btn bg-[#06C755] rounded-2xl w-full md:w-1/2 h-16 md:h-20 max-w-[85%] m-auto grid place-items-center text-white font-semibold md:text-xl relative hover:brightness-90"
            target="_blank"
          >
            <Image
