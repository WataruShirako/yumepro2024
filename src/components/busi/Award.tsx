...
const Award = () => {
  return (
    <>
      <section className="award my-16 md:my-20">
        ...
        <div className="container px-5 flex flex-col md:flex-row items-center justify-center mt-10 gap-5">
          <div className="img">
        ...
        <div className={'mt-5'}>
          <h2 className={'text-2xl container px-5'}>アワード応募概要</h2>
