...
const Avdiser = () => {
  return (
    <>
      <section className="adviser my-16 md:my-20">
        ...
        <div className="container flex items-center justify-center flex-col md:flex-row mt-10 gap-5">
          <div className="itemImg">
            ...
            />
            <p className="text-center mt-2 text-lg">丸尾浩一</p>
          </div>
          <div className="itemText px-5">
            <p>
              株式会社Major7th　代表取締役
              <br />
