        ...
        <section id="sponsor" className="pt-12 md:pt-24">
          ...
          <div className=" overflow-x-auto p-5">
            <table className="table-fixed mx-auto  border border-inherit border-2 bg-gradient-to-tr from-[#C52CFD] to-[#2D4BB5]">
              <thead>
                ...
                <tr>
                  <th className="border border-inherit border-2 [writing-mode:vertical-rl] [text-orientation: sideways]  py-3 px-2  text-white">
                    <span className="">映画・テレビ出演権</span>
                  </th>
                  <th className="border border-inherit border-2  sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl]  py-3 px-2  text-white">
                  ...
                  <th className="   sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl]  py-3 px-1  text-white">
                    ＳＡＫＵＲＡ貸切権
                  </th>
                  <th className="   sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl]  py-3 px-1  text-white">
                    レストラン
              ...
              <tbody>
                <tr>
                  ...
                  <td
                    colSpan={2}
                    className="text-center border border-inherit border-2 px-1 text-sm bg-white"
                  >
                    年間30回
                  </td>
                  <td className="text-center border border-inherit border-2 px-1 text-sm bg-white">
          ...
          <div id="sponsor_detail" className="py-10 px-2">
            ...
            <table className="table-fixed mx-auto  border border-inherit border-2 ">
              <thead>
                <tr>
                  <th className="border border-inherit border-2 p-3 sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl] text-white bg-[#888888] text-center">
              ...
              <tbody>
                <tr>
                  <td
                    rowSpan={4}
                    className="border border-inherit border-2 p-2 sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl]  bg-white text-center text-sm sm:text-base"
                  >
                ...
                <tr>
                  <td
                    rowSpan={8}
                    className="border border-inherit border-2 p-2 bg-white  sm:[writing-mode:vertical-rl] [writing-mode:sideways-rl]  text-center text-sm sm:text-base"
                  >
                    授賞式当日
                  </td>
                  <td className="border border-inherit border-2 p-2 bg-white text-sm sm:text-base">
