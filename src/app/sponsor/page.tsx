        ...
        <section id="sponsor" className="pt-12 md:pt-24">
          ...
          <div className=" overflow-x-auto p-5">
            <table className="table-fixed mx-auto  border border-inherit border-2 bg-gradient-to-tr from-[#C52CFD] to-[#2D4BB5]">
              <thead>
                ...
                <tr>
                  <th className="border border-inherit border-2  [writing-mode:vertical-rl] [text-orientation: upright]  py-3 px-2  text-white">
                  ...
                  <th className="   [writing-mode:vertical-rl] [text-orientation: upright]  py-3 px-1  text-white">
                    ＳＡＫＵＲＡ貸切権
                  </th>
                  <th className="   [writing-mode:vertical-rl] [text-orientation: upright]  py-3 px-1  text-white">
                    レストラン
          ...
          <div id="sponsor_detail" className="py-10 px-2">
            ...
            <table className="table-fixed mx-auto  border border-inherit border-2 ">
              <thead>
                <tr>
                  <th className="border border-inherit border-2 p-3 [writing-mode:vertical-rl] [text-orientation: upright] text-white bg-[#888888] text-center">
              ...
              <tbody>
                <tr>
                  <td
                    rowSpan={4}
                    className="border border-inherit border-2 p-2 [writing-mode:vertical-rl] [text-orientation: upright]  bg-white text-center text-sm sm:text-base"
                  >
                ...
                <tr>
                  <td
                    rowSpan={8}
                    className="border border-inherit border-2 p-2 bg-white  [writing-mode:vertical-rl] [text-orientation: upright]  text-center text-sm sm:text-base"
                  >
                    授賞式当日
                  </td>
                  <td className="border border-inherit border-2 p-2 bg-white text-sm sm:text-base">
