    ...
    <>
      ...
      <main id="yumephoto">
        ...
        <section className="pt-[25px]">
          ...
          <div className={'max-w-[92%] md:max-w-[58rem] m-auto mt-8'}>
            <h5 className={'font-bold'}>クリエイターからのコメント</h5>
            <p className={'mt-4'}>
              この度、フォトコン優勝作品に選ばせていただきました松尾一也です。
              <br />
              何枚もの写真の中から見つけて、そして選んでいただきありがとうございます。
              <br />
              普段は看護師ですが、カメラを持って絶景へいくのを趣味としています。
              <br />
              主に広角レンズを使用し絶景と季節折々の風景ポートレートを主として撮影しています。見ている人が少しでもその場所の雰囲気や季節感を一目見て感じてもらえるよう光や余白、季節ものを意識して撮影、編集しています。職業柄も関係していますが、コロナ禍だからこそ写真でも誰かの癒しを与えられるような作品となればなと日々思っております。
              <br />
              これを機にまた沢山の方に写真の魅力が伝われば幸いです！ありがとうございました！
            </p>
          </div>
        </section>
        <Entry />
