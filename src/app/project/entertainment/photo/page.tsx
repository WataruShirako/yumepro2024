...
const Home = () => {
  ...
  const about = {
    ...
    status: `
      ・日本国内に在住のアマチュアの方<br>
      ・2024年4月27日の授賞式に参加できる方<br>
      ・夢プロ公式Instagramをフォローしている方<a href="https://www.instagram.com/yumekanaeru_pj/" target="_blank" style='text-decoration: underline; color: #06b6d4;'>(公式アカウントはこちら)</a><br>
      ・「#夢フォト2024」をつけて投稿している方
    `,

    award: "2024年4月27日 <br />幕張メッセ inニコニコ超会議",
  };
      ...
      <main id="yumephoto" className={"entt"}>
        ...
        <section className="container m-auto max-w-[92%] md:max-w-5xl">
          ...
          <p className={"mt-4 text-sm"}>
            本企画の主催は、株式会社ホステックが行い、運営業務は株式会社ホステックが行います。
            <br />
            ...
            個人情報管理責任者 株式会社ホステック
            <br />
            ※賞品の発送は、株式会社ホステックが行います。
            <br />
            運営業務委託先
            <br />
            株式会社ホステック
            <br />
            ※賞品の発送・配送は、株式会社ホステックおよび株式会社ホステックが委託する企業が行います。
          </p>
          <h2
            className={
          ...
          <p className={"mt-4 text-sm "}>
            ...
            <br />
            受賞者は、受賞作品を株式会社ホステックのPR用などに使用する目的で株式会社ホステックが許可した第三者を含むものとし、以下同じとします）が、無償かつ無期限に使用、掲載、転載、公衆送信等することを承諾するものとします。応募作品については、撮影者に事前に許諾確認の上、上記同様使用することがございます。応募者は、株式会社ホステックに対し、著作者人格権に基づく権利の主張を一切行わないものとします。
            <br />
            前項の株式会社ホステックによる使用において、応募者の承諾を得ることなく応募作品のトリミング・画像効果並びに音楽および音響効果を加えるなどの編集・改変を行うことがあることを承諾するものとします。
            <br />
            ...
            <br />
            応募作品に関して万一法律上の問題が生じた場合、応募者の責任および負担において、その一切を解決するものとし、株式会社ホステックは何ら責任を負いません。
            <br />
            ...
            <br />
            本コンテストは、株式会社ホステックが主催・運営を行っております。Meta社およびInstagramは本コンテストの後援、承認、運営を一切行っておらず、Meta社およびInstagramとは一切関係がありません。また本コンテストへの参加、および賞品に関して、Meta社およびInstagramは一切の関与をせず、応募者はそのことに同意したものとみなされます。
            <br />
            Facebook /
            Instagramおよび本コンテストの中断、または中止によって生じるいかなる損害についても、株式会社ホステックが責任を負うものではありません。本コンテストの内容は、予告なく変更する場合があります。
            <br />
